            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" side="bottom">
                {[
                  ...
                  { label: "YAML (.yaml)", name: "config.yaml" },
                  { label: "TOML (.toml)", name: "config.toml" },
                  { label: "XML (.xml)", name: "data.xml" },
                  { label: "HTML (.html)", name: "index.html" },
                  { label: "CSS (.css)", name: "style.css" },
                  { label: "JavaScript (.js)", name: "script.js" },
                  { label: "TypeScript (.ts)", name: "main.ts" },
                  { label: "Python (.py)", name: "main.py" },
