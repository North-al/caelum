...
/** Convenience wrapper matching the previous options/onChange API used in Settings. */
interface NativeSelectProps extends Omit<React.SelectHTMLAttributes<HTMLSelectElement>, "children"> {
  options: Array<{ label: string; value: string }>
}

const NativeSelect = React.forwardRef<HTMLSelectElement, NativeSelectProps>(
  ({ className, options, value, onChange, disabled, id, name }, ref) => {
    ...
    return (
      ...
      >
        <SelectTrigger ref={ref as never} className={cn("w-full", className)}>
          <SelectValue placeholder="请选择">{selected?.label ?? "请选择"}</SelectValue>
        </SelectTrigger>
